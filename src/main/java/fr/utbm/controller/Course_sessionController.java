...
public class Course_sessionController {
	...
	public List<Course_session> getAllCourse_session() {
		return course_sessionService.getAllCourse_sessionsService();
	}

	public Course_session getCourse_sessionById(String id_session) {
		return course_sessionService.getCourse_sessionFromIdService(Integer.parseInt(id_session));
	}

	public Course_session getCourse_sessionById(Integer id_session) {
		return course_sessionService.getCourse_sessionFromIdService(id_session);
	}
}
