...
public class FormationsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(type.equals("date-sorting")) {
            ...
            int id = Integer.getInteger(request.getParameter("place"));
        ...
        out.println("<div class=\"date-sorting modale\">" +
                ...
                "Choisir une date : <input type=\"text\"  id=\"datepicker\">" +
        ...
        for (Location location : locations) {
            out.println("<option>" + location.getId_location() + " - " + location.getCity() + "</option>");
        }
        out.println("</select>" +
                "<button type=\"submit\" class=\"btn btn-primary\">Valider</button>" +
                "</form>" +
        ...
        out.println("<div class=\"filter-sorting modale\">" +
                ...
                "Mot-clé : <input type=\"text\"  id=\"keyword\">" +
                "<button type=\"submit\" class=\"btn btn-primary\">Valider</button>" +
                "<img src=\"styles/svg/close.svg\" class=\"close-modale\"/>" +
                "</form>" +
                "</div>");
